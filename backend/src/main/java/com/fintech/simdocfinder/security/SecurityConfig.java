    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/audit/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_AUDITOR")
                .requestMatchers("/api/alerts/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_FINANCE_MANAGER")
                ...
                .requestMatchers(HttpMethod.GET, "/api/documents/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_FINANCE_MANAGER", "ROLE_FINANCE_CLERK", "ROLE_AUDITOR", "ROLE_VIEWER")
