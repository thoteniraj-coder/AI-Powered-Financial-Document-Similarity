...
public interface DocumentRepository extends JpaRepository<Document, UUID> {
    ...
    Page<Document> findByIsDeletedFalseAndCreatedAtAfter(LocalDateTime createdAt, Pageable pageable);
    List<Document> findByIsDeletedFalseAndDocumentTypeAndCreatedAtBefore(String documentType, LocalDateTime createdAt);
}
